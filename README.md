...
Движок: **Godot 4.8-dev4 .NET**. Язык: **C# / .NET 8**. Автор репозитория: [assassins377](https://github.com/assassins377).
...
| Мониторинг | внутриигровой оверлей статистики (FPS, frametime, draw calls, память, узлы) — компактный/подробный |
...
- Godot **4.8-dev4 .NET** (сборка `Godot_v4.8-dev4_mono_linux`)
- **.NET 8** SDK

1. Клонируйте репозиторий и откройте папку в Godot 4.8-dev4 (.NET).
